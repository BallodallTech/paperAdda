...
const Footer = () => {
  return (
    <footer className="relative block text-white">
      <img
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="py-16 md:py-24 lg:py-32">
            <div className="flex-col flex items-center">
              <a href="#" className="flex space-x-2 max-w-full">
                <Image src="/book.png" alt="" width={40} height={40} />
                <h2 className="text-3xl font-semibold">PapperAdda</h2>
              </a>
              <div className="mx-auto mt-4 max-w-[528px]">
                <p className="text-center text-[#636262]">
                  Unlock a world of learning possibilities with PaperAdda, your
                  all-in-one destination for educational enrichment.
                </p>
              </div>
              <div className="mt-10 text-center font-semibold max-[991px]:ml-0 max-[991px]:mr-0 max-[991px]:py-1">
                <a
                  href="#"
                  className="inline-block px-6 py-2 font-normal text-white [border-bottom:1px_solid_rgba(0,_0,_0,_0)] transition hover:text-white hover:[border-bottom:1px_solid_rgb(201,_253,_2)]"
                >
                  About
                </a>
                <a
              ...
              <div className="mb-16 mt-10 flex grid-flow-col grid-cols-4 place-items-center gap-[28px] bg-[#101010] px-6 py-2.5 rounded-full">
                <a
                  href="#"
                  className="mx-auto flex-col flex max-w-[24px] items-center justify-center text-[#3a3a3a] transition hover:text-[#c9fd02]"
                >
                  <div className="">
                    <svg
                      width="40"
